...
class Movement{
    ...
    public:
        ...
        // grid pieces are indexed starting from 1 when reading in but stored in matrix starting from index 0
                ...
                if (piece->getName() == pieceName) {
                    ...
                    switch (direction) {
                        case 'u':
                            ...
                            if (piece->moveableDirection() != 'v' && piece->moveableDirection() != 'b') {
                                return NULL;
                            }
                            ...
                            // is there another piece in the movement direction / if piece falls off grid
                            ...
                            Piece* newPiece = new Piece(pieceName, row, col, height, width, piece->moveableDirection(), gridSpacesOccupied);
                        ...
                        case 'l':
                            // check if piece can move in specified direction
                            if (piece->moveableDirection() != 'h' && piece->moveableDirection() != 'b') {
                                return NULL;
                            }
                            int col = piece->getCol();
                            int height = piece->getHeight();
